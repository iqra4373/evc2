...
public class evcplas {
    ...
    public static void main(String[] args) {
        ...
        if (code.equals(ZIP_CODE)) {
            ...
            System.out.println("Code-ka aad gelisay waa khalad.");
        }
    }
    ...
    private static void displayMainMenu() {
        ...
        switch (choice) {
            ...
            case "0": System.out.println("Macsalaama!"); System.exit(0); break;
            default: System.out.println("Doorasho aan sax ahayn."); displayMainMenu();
        }
    }
    ...
    private static void kuShuboMenu() {
        ...
        System.out.println("3: wIFI Packages");
    ...
    private static void salaamBankMenu() {
        ...
        switch (choice) {
            ...
            case "3":
                ...
                break;
            case "4":
                processTransaction("Ka wareeji Evc Plus");
                break;
            default:
                System.out.println("Doorasho aan sax ahayn.");
        }
    ...
    private static void warbixinKoobanMenu() {
        ...
        switch (choice) {
            ...
            case "4": showLastThreeActions(); break;
